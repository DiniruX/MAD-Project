    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addCategoryBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.example.ecomarket.CategoryRVModal categoryRVModal = new com.example.ecomarket.CategoryRVModal(categoryName,categoryDescription,categoryDate,categoryImage,categoryID);

                databaseReference.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        loadingPB.setVisibility(View.GONE);
                        databaseReference.child(categoryID).setValue(categoryRVModal);
